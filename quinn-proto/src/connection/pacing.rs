...
impl Pacer {
    ...
    pub(super) fn delay(
        ...
        let window = rate_limited_window(smoothed_rtt, window, self.pacing_gain, self.max_bytes_per_second);
        ...
        let time_elapsed = now.checked_duration_since(self.last_update).unwrap_or_else(|| {
